...
function showBrands() {
	if ($(this).val() == "show") {
		// $('[class="brand_sort active"]').prop('checked', true);
		$('[class="brands_show_all"][value="show"]').addClass("hidden");
		$(".ab_full").removeClass("hidden");
		$(".aside_brands").addClass("aside_brands_long_bg");
	}
	else if ($(this).val() == "hide") {
		$(".ab_full").addClass("hidden");
		$(".brands_show_all").removeClass("hidden");
		$(".aside_brands").removeClass("aside_brands_long_bg");
	}
}
...
$(document).ready(function() {
	$.getJSON("js/goods.json", function(data) {
		for (var key in data){
			if (data[key].category == "el_acoustic") {
